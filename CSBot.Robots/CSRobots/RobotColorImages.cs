...
namespace CSRobots
{
    internal class RobotColorImages
    {
        ...
        public RobotColorImages(int team)
        {
            ...
            for (var j = 0; j < 36; j++)
            {
                Bodies.Add(EmbeddedImage.ModifyImageResource("CSRobots." + DefaultSkinPrefix + "body" + j.ToString("D2") + "0.gif", c1, c2, c3));
                Turrets.Add(EmbeddedImage.ModifyImageResource("CSRobots." + DefaultSkinPrefix + "turret" + j.ToString("D2") + "0.gif", c1, c2, c3));
                Radars.Add(EmbeddedImage.ModifyImageResource("CSRobots." + DefaultSkinPrefix + "radar" + j.ToString("D2") + "0.gif", c1, c2, c3));
            }
        }
    }
}
